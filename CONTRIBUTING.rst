...
Welcome to ``sample_deployment`` contributor's guide.
...
If you experience bugs or general issues with ``sample_deployment``, please have a look
...
You can help improve ``sample_deployment`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``sample_deployment`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``sample_deployment``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n sample_deployment python=3 six virtualenv pytest pytest-cov
    conda activate sample_deployment
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/sample_deployment.git
...
#. Install |pre-commit|_::
   ...
   ``sample_deployment`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/sample_deployment
.. _issue tracker: https://github.com/<USERNAME>/sample_deployment/issues
.. <-- end -->
