...
Welcome to ``sample_endpoint`` contributor's guide.
...
If you experience bugs or general issues with ``sample_endpoint``, please have a look
...
You can help improve ``sample_endpoint`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``sample_endpoint`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``sample_endpoint``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n sample_endpoint python=3 six virtualenv pytest pytest-cov
    conda activate sample_endpoint
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/sample_endpoint.git
    cd sample_endpoint
...
#. Install |pre-commit|_::
   ...
   ``sample_endpoint`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/sample_endpoint
.. _issue tracker: https://github.com/<USERNAME>/sample_endpoint/issues
.. <-- end -->
